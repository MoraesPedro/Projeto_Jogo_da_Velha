...
def validaEntrada(tabuleiro, letraNumero):
    """
    Valida entrada do usuárAio para possíveis erros de digitação, cordenadas inválidas ou já utilizadas
...
Código criado pelos alunos - Jogada da Máquina
...
def jogadaMaquina(tabuleiro, jogada):
    ...
    if jogada == 1:
        ...
        # Possibilidade 2
        elif tabuleiro["B"][0] == "O":
            tabuleiro["A"][2] = "X"

        # Possibilidade 3
        elif tabuleiro["B"][2] == "O":
            tabuleiro["C"][0] = "X"
            

        # Possibilidade 4
        elif tabuleiro["C"][1] == "O":
            tabuleiro["A"][2] = "X"
            

        # Possibilidade 5 MEIO
        elif tabuleiro["B"][1] == "O":
            tabuleiro["A"][2] = "X"
        

        # Possibilidade 6
        elif tabuleiro["A"][2] == "O":
            tabuleiro["C"][0] = "X"
            

        # Possibilidade 7
        elif tabuleiro["C"][0] == "O":
            tabuleiro["A"][2] = "X"
            

        # Possibilidade 8
        elif tabuleiro["C"][2] == "O":
            tabuleiro["C"][0] = "X"
        ...
        print(jogada)
         ...
         # Possibilidade 1
        if tabuleiro["A"][1] == "O" and tabuleiro["C"][0] == "X":
            if tabuleiro["B"][0] == "O":
                tabuleiro["C"][2] = "X"
            else:
                tabuleiro["B"][0] = "X"
         ...
         # Possibilidade 3
        elif tabuleiro["B"][2] == "O" and tabuleiro["C"][0] == "X":
            if tabuleiro["B"][0] == "O":
                tabuleiro["B"][1] = "X"
            else:
                tabuleiro["B"][0] = "X"
         ...
         # Possibilidade 4
        elif tabuleiro["C"][1] == "O" and tabuleiro["A"][2] == "X":
            if tabuleiro["A"][1] == "O":
                tabuleiro["B"][1] = "X"
            else:
                tabuleiro["A"][1] = "X"
        ...
        # Possibilidade 5 MEIO
        elif tabuleiro["B"][1] == "O" and tabuleiro["A"][2] == "X":
            if tabuleiro["A"][1] == "O":
                tabuleiro["C"][1] = "X"
            else:
                tabuleiro["A"][1] = "X"
         ...
         # Possibilidade 6
        elif tabuleiro["A"][2] == "O" and tabuleiro["C"][0] == "X":
            if tabuleiro["B"][0] == "O":
                tabuleiro["C"][2] = "X"
            else:
                tabuleiro["B"][0] = "X"
         ...
         # Possibilidade 8
        elif tabuleiro["C"][2] == "O" and tabuleiro["C"][0] == "X":
            if tabuleiro["B"][0] == "O":
                tabuleiro["A"][2] = "X"
            else:
                tabuleiro["B"][0] = "X"
         ...
         # Possibilidade 1
        if tabuleiro["A"][1] == "O" and tabuleiro["B"][0] == "O" and tabuleiro["C"][0] == "X" and tabuleiro["C"][2] == "X":
            if tabuleiro["B"][1] == "O":
                tabuleiro["C"][1] = "X"
            elif tabuleiro["C"][1] == "O":
                tabuleiro["B"][1] = "X"
         ...
         # Possibilidade 2
        elif tabuleiro["A"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["B"][0] == "O" and tabuleiro["C"][2] == "X":
            if tabuleiro["B"][1] == "O":
                tabuleiro["B"][2] = "X"
            elif tabuleiro["B"][2] == "O":
                tabuleiro["B"][1] = "X"
         ...
         # Possibilidade 3
        elif tabuleiro["B"][1] == "X" and tabuleiro["B"][2] == "O" and tabuleiro["B"][0] == "O" and tabuleiro["C"][0] == "X":
            if tabuleiro["A"][2] == "O":
                tabuleiro["C"][2] = "X"
            elif tabuleiro["C"][2] == "O":
                tabuleiro["A"][2] = "X"
         ...
         # Possibilidade 4
        elif tabuleiro["C"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["A"][1] == "O" and tabuleiro["B"][1] == "X":
            if tabuleiro["C"][0] == "O":
                tabuleiro["C"][2] = "X"
            elif tabuleiro["C"][2] == "O":
                tabuleiro["C"][0] = "X"
         ...
         # Possibilidade 5 MEIO
        elif tabuleiro["B"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["A"][1] == "O" and tabuleiro["C"][1] == "X":
            if tabuleiro["B"][0] == "O":
                tabuleiro["B"][2] = "X"
            elif tabuleiro["B"][2] == "O":
                tabuleiro["B"][0] = "X"
         ...
         # Possibilidade 6
        elif tabuleiro["A"][2] == "O" and tabuleiro["C"][0] == "X" and tabuleiro["B"][0] == "O" and tabuleiro["C"][2] == "X":
            if tabuleiro["C"][1] == "O":
                tabuleiro["B"][1] = "X"
            elif tabuleiro["B"][1] == "O":
                tabuleiro["C"][1] = "X"
        ...
        # Possibilidade 7
        elif tabuleiro["A"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["C"][0] == "O" and tabuleiro["C"][2] == "X":
            if tabuleiro["B"][1] == "O":
                tabuleiro["B"][2] = "X"
            elif tabuleiro["B"][2] == "O":
                tabuleiro["C"][1] = "X"
        ...
        # Possibilidade 8
        elif tabuleiro["C"][2] == "O" and tabuleiro["C"][0] == "X" and tabuleiro["B"][0] == "O" and tabuleiro["A"][2] == "X":
            if tabuleiro["B"][1] == "O":
                tabuleiro["A"][1] = "X"
            elif tabuleiro["A"][1] == "O":
                tabuleiro["B"][1] = "X"
            else:
                tabuleiro["B"][1] = "X"
         ...
         # Possibilidade 5        
        if tabuleiro["B"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["A"][1] == "O" and tabuleiro["C"][1] == "X" and tabuleiro["B"][0] == "O" and tabuleiro["B"][2] == "X":
            if tabuleiro["C"][0] == "O":
                tabuleiro["C"][2] = "X"
            else:
                tabuleiro["C"][0] = "X"

        elif tabuleiro["B"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["A"][1] == "O" and tabuleiro["C"][1] == "X" and tabuleiro["B"][2] == "O" and tabuleiro["B"][0] == "X":
            if tabuleiro["C"][0] == "O":
                tabuleiro["C"][2] = "X"
            else:
                tabuleiro["C"][0] = "X"
        elif tabuleiro["B"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["A"][1] == "O" and tabuleiro["C"][1] == "X" and tabuleiro["C"][2] == "O" and tabuleiro["C"][0] == "X":
            if tabuleiro["B"][0] == "O":
                tabuleiro["B"][2] = "X"
            else:
                tabuleiro["B"][0] = "X"
        elif tabuleiro["B"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["A"][1] == "O" and tabuleiro["C"][1] == "X" and tabuleiro["C"][0] == "O" and tabuleiro["C"][2] == "X":
            if tabuleiro["B"][0] == "O":
                tabuleiro["B"][2] = "X"
            else:
                tabuleiro["B"][0] = "X"
